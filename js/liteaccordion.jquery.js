...
jQuery(function() {
  jQuery(".easy-accordion li.slide > div").click(function() {
    jQuery(this).prev("h2").find("span").click();
  });
  jQuery(".easy-accordion li.slide > div").mouseover(function() {
    if (!jQuery(this).prev("h2").hasClass("selected")) {
